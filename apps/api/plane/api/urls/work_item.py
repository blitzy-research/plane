...
new_url_patterns = [
    ...
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/work-items/<uuid:pk>/duplicate/",
        IssueDuplicateAPIEndpoint.as_view(http_method_names=["post"]),
        name="work-item-duplicate",
    ),
    path(
